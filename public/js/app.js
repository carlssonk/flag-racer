...
function mainPage() {
  ...
  document.title = "FlagRacer: Free Multiplayer Flag Guessing Game"
  ...
  const randomFlagCode1 = emotes[Math.floor(Math.random() * emotes.length)]['alpha-2']
  const randomFlagCode2 = emotes[Math.floor(Math.random() * emotes.length)]['alpha-2']
  const randomFlagCode3 = emotes[Math.floor(Math.random() * emotes.length)]['alpha-2']
  ...
  this.mainPageHTML = function() {
    return (
      ...
      <div class="landing-container">
        <div class="title-container flag-racer">
        FlagRacer
        </div>
        <div class="games-container main-lower">
          <div class="game-box">
            <img class="game-box-background-img" src="https://flagcdn.com/w320/${randomFlagCode1}.png">
            <div class="play-box">
              <h1>Battle Royale</h1>
          ...
          <div class="game-box">
            <img class="game-box-background-img" src="https://flagcdn.com/w320/${randomFlagCode2}.png">
            <div class="play-box">
              <h1>1 VS 1</h1>
          ...
          <div class="game-box">
            <img class="game-box-background-img" src="https://flagcdn.com/w320/${randomFlagCode3}.png">
            <div class="play-box">
              <h1>Practice Solo</h1>            
              <button class="play-btn solo-play-btn">Play</button>
            </div>            
            <div>
              <p>Practice by yourself, imporve flag skills.</p>
            </div>
...
function soloPage() {
  ...
  // CONFIG
  document.title = "FlagRacer: Practice Solo"
...
function profilePage() {
  // CONFIG
  document.title = "FlagRacer: My Profile"
